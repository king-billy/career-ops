...
2. **Select primary target**: the person who would benefit most from having the candidate there
...
3. **Generate message** using the 3-sentence framework:
   ...
   - **Sentence 2 (Proof)**: Candidate's most relevant quantifiable achievement for THAT role (e.g., "I built an AI agent handling 90% of customer service at my company before selling it")
