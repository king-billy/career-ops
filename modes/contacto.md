...
2. **Classify contact type** -- ask the candidate or infer from context:
   ...
   - **Hiring Manager** -- the person who leads the team that is hiring
...
4. **Generate message** using the 3-sentence framework adapted to contact type:
   ...
   ### Hiring Manager
   - **Sentence 1 (Hook)**: Something specific about their company or current challenge (NOT generic, extracted from JD, company blog, or news)
   - **Sentence 2 (Proof)**: Candidate's most relevant quantifiable achievement that shows they have solved similar problems
   ...
   - **Sentence 1 (Research)**: Reference to something specific about their work or career path
